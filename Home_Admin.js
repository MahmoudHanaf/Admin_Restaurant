...
import Add_meal from '../Tasks/Add_meal'
import Menu from '../Tasks/Menu'
import Edit_Menu from '../Tasks/Edit_Menu'
...

 {
   this.state.loading ==true ? (
    ...
    <View style={styles.header}>
      ...
      <Text style={{ fontSize: 23, fontWeight: 'bold', }}>New Orders</Text>
...
<View style={styles.container}>
      <ScrollView>

        {
          ...
          <Text style={{fontSize:15,fontWeight:'500',marginTop:10}}>{data.order_date}</Text>
          </View>
